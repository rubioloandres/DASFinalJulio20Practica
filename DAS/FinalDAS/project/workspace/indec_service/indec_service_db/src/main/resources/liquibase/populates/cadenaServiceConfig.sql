...
VALUES
    ...
    , (6,6,1,'http://localhost:8010/cadena_cxf_three/services/cadena_cxf_three?wsdl') -- EXTRA - SUPERMAMI3 - CXF3
--    , (6,6,2,'http://localhost:8010/cadena_rest_three/cadenaRestThree') -- EXTRA - SUPERMAMI2 - REST3
--    , (6,6,1,'http://localhost:8010/cadena_axis_two/services/CadenaAxisTwo?wsdl') -- EXTRA - SUPERMAMI - AXIS2
